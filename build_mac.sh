...
echo ""
echo "Build complete! Executable is in: dist/ImageFetcherBot"
echo ""
echo "IMPORTANT: Copy these items to the same folder as the executable:"
...
echo ""
echo "To run: ./ImageFetcherBot --run-once --sku-file my_skus.txt"
